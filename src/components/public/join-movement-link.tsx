...
export function JoinMovementLink({
  ...
  return (
    ...
    <Link
      ...
      onClick={onNavigate}
      className={`inline-flex items-center justify-center gap-2 rounded-pill bg-brand-900 px-5 py-2.5 text-sm font-medium text-white transition-colors hover:bg-brand-800 ${className ?? ""}`}
    >
      Join the Movement
